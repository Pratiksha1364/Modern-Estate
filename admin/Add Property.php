...
{
if(!file_exists('properties_image/'.$filename))
{
move_uploaded_file($filename_tmp, 'properties_image/'.$filename);
...
move_uploaded_file($filename_tmp, 'properties_image/'.$newfilename);
