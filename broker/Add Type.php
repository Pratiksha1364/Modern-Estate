...
<head>
  ...
  <title>Modern Estate | Add Type</title>
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="card-header">
            ...
            <div class="form-group">
                  <button type="submit" class="btn btn-primary" name="updateprop">Add</button>
                  &nbsp;
...
{
    echo'<script>alert("Do you Want to cancel")</script>';
    if (!isset($_GET['reload'])) {
...
$ptname=$_POST['ptype'];
$check_type = mysqli_query($con, "SELECT PROERTY_TYPE_NAME FROM property_type WHERE PROERTY_TYPE_NAME = '$ptname' AND PROPERTY_STATUS=1");
    if(mysqli_num_rows($check_type) > 0)
    {
       echo "SAME TYPE ALREADY EXISTS! TRY ADDING DIFFRENT TYPE";

    }
  else{
        $qu="INSERT INTO property_type(PROERTY_TYPE_NAME,PROPERTY_STATUS) VALUES ('$ptname',1)";
