...
<div class="wrapper">
 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <?php
	$id= $_GET['id'];
	$qry="SELECT * FROM contactus_table	 WHERE CONTACT_ID='$id'";
	$result = mysqli_query($con,$qry);
	while($value = mysqli_fetch_array($result)){
        $conid=$value['CONTACT_ID'];
		$username=$value['NAME'];
		$useremail=$value['EMAIL_ID'];
		$userphone=$value['PHONE_NO'];
		$usersub=$value['SUBJECT'];
        $usermsg=$value['YOUR_QUERY'];
	}
	?>
    <!-- Main content -->
    <div class="main1">
    <div class="card-header">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label>Subject</label>
                <input type="text" name="esub" value="<?php echo $usersub;?>" class="form-control" disabled>
              </div>
              <div class="form-group">
                <label>Subject</label>
                <input type="text" name="emessage" value="<?php echo $usermsg;?>" class="form-control" disabled>
              </div>
              <div class="form-group">
                  <a href="Manage Query.php"><button type="submit" class="btn btn-primary"><a href="Manage Query.php">GO BACK</a></button></a>
              </div>
</form>
            </div>
