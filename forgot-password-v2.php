...
<head>
  ...
  <title>Modern Estate | Forgot Password </title>
...
<div class="login-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index.php" class="h1"><b>Mother </b>Estate</a>
    </div>
    <div class="card-body">
...
<!--               <span class="fas fa-envelope"></span>
 -->            </div>
      ...
      $a=$_POST['femail'];
        $uemail=$a;
        $query=("SELECT EMAIL FROM login_table WHERE EMAil='". $uemail."'");
      ...
      if($count==1)
      {
        ...
        if (!isset($_GET['reload'])) {
          ...
          echo '<meta http-equiv=Refresh content="0;url=recover-password-v2.php?reload=1">';
                }
      }
      else
      {
