                ...
                <div class="single-left">
                    ...
                    <div class="single-left1">
                       <br>
                        ...
                        ?>
                        - <span class="price">from &#8377; <!--750--><?php if(strlen($propprice)>=5)
                            { 
...
?>
                    ...
                    <div class="single-left1">
                        ...
                        <ul class="details-list">
                            ...
                            <!-- <li><strong>Property size :</strong>  </li> -->
                            ...
                            <li><strong>Property Price :</strong> &#8377; <?php echo substr($propprice,0,2).",".substr($propprice,2,3);?> </li>
                    ...
                    <?php 
                        ...
                        {
                          ?>
                            <a href="bookapointment.php?id=<?php echo $id?>"><button type="button" name="ba" class="btn btn-block btn-outline-primary">Book Apointment </button></a>
                        <?php
                          }
                        ?>
                    <!-- <div class="single-left1">
