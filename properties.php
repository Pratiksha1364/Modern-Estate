...
<head>
  ...
  <title>Modern Estate | Properties </title>
...
$value['PRICE']; }?></span>
                            <p><!--Nulla ex nunc, interdum nec egestas nec, dapibus ac mauris. Vivamus id tempor nisl.--><?php echo substr($value['DESCRIPTION'],0,45);?></p>
                            <ul>
...
substr($value['PRICE'],0,2).",".substr($value['PRICE'],2,3); } else{ echo
$value['PRICE']; }?></span>
                            <p><!--Nulla ex nunc, interdum nec egestas nec, dapibus ac mauris. Vivamus id tempor nisl.--><?php substr($value['DESCRIPTION'],0,45);?></p>
                            <ul>
                              <li style="color: skyblue;"><?php echo date('d F Y ', strtotime($value['TIMESTAMP'])); ?></li>                                <!-- <li><span class="fa fa-bed"></span> 3</li>
                                <li><span class="fa fa-bath"></span> 3</li>
                                <li><span class="fa fa-share-square-o"></span> 1200 sq ft</li> -->
...
<?php echo substr($value['DESCRIPTION'],0,45);?></p> <ul> 
