...
<link rel="icon" type="image/x-icon" href="../admin/dist/img/AdminLTELogo.png">
  ...
  <title>Morden Estate | Contact </title>
...
<section class="w3l-contacts-12">
	<div class="wrapper">
		<div class="contacts12-main">
			<h3 class="contact-head">we are here for you</h3>
			...
			<form action="" method="post">
				<div class="main-input">
					...
					<input type="email" name="w3lemail" placeholder="Your email id" class="contact-input" required/>
          <input type="number" name="w3lphone" placeholder="Your phone no" class="contact-input" required/>
					<input type="text" name="w3lSubject" placeholder="Subject" class="contact-input" required/>
				</div>
        
				<textarea class="contact-textarea" name="w3lMessage" placeholder="Your message here" required></textarea>
				<button class="actionbg btn" name="submit">Submit</button>
			</form>
		</div>
	</div>
</section>	
...
{
  $name=$_POST['w3lName'];
  $email=$_POST['w3lemail'];
  $phone=$_POST['w3lphone'];
  $subject=$_POST['w3lSubject'];
  $msg=$_POST['w3lMessage'];

  
  $query1="INSERT INTO contactus_table(NAME, EMAIL_ID, PHONE_NO, SUBJECT, YOUR_QUERY) 
